  ...
  if menu.updated == true then
    ...
    if value2 ~= nil then
      ...
      elseif value == 3 then -- QGIS
        menuItems[idx2][4] = { "default", "layer1", "layer2", "layer3" }
        menuItems[idx2][5] = { "qgis_default", "qgis_layer1", "qgis_layer2", "qgis_layer3" }
      end
    ...
    if value2 ~= nil then
      ...
      elseif value == 2 then     -- Google
        ...
        menuItems[idx2][4] = 1
        menuItems[idx2][5] = 25
        menuItems[idx2][3] = math.min(value2,25)
      end
    end
...
local function drawConfigMenu(event)
  ...
  elseif menu.selectedItem  < 1 then
    ...
    menu.offset =  #menuItems - 10
  end
  --
  for m=1+menu.offset,math.min(#menuItems,10+menu.offset) do
    lcd.setColor(CUSTOM_COLOR,WHITE)
